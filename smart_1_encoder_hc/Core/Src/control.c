...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
    ...
    {   
        uint16_t speed_motor_0 = Get_Speed(0);
        printf("speed_motor_0 = %d\r\n", speed_motor_0);
        uint16_t speed_motor_1 = Get_Speed(1);
        printf("speed_motor_1 = %d\r\n", speed_motor_1);
        uint16_t speed_motor_2 = Get_Speed(2);
        printf("speed_motor_2 = %d\r\n", speed_motor_2);
        uint16_t speed_motor_3 = Get_Speed(3);
        printf("speed_motor_3 = %d\r\n", speed_motor_3);
    }
}
...
uint16_t Get_Speed(int motor_index)
{
    ...
    {
    case 0:
        Motor_Speed = __HAL_TIM_GET_COUNTER(&htim2); // 使用对应的定时器
